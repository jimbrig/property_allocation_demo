...
<p>
<center>
<img src="propalloc-logo.png" width = "50%"/>
</center>
</p>
<center>
...
costs <- extract_costs(initial_costs)
...
initial_relativities <- propalloc::relativities
...
relativity_adjusted_tivs <- apply_rels(
  propalloc::bu_rels, propalloc::sprinkler_tier_rels, propalloc::combustible_rels,
  propalloc::sov
)
...
entity_data <- merge_entity_data(sov, relativity_adjusted_tivs, entity_loss_data, rates, priors = priors)
# names(entity_data)
```
