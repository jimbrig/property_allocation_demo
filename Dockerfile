...
RUN apt-get update && apt-get upgrade && apt-get install -y git-core imagemagick libcurl4-openssl-dev libgit2-dev libglpk-dev libgmp-dev libssh2-1-dev libssl-dev libxml2-dev make pandoc pandoc-citeproc zlib1g-dev && rm -rf /var/lib/apt/lists/*
...
RUN Rscript -e 'remotes::install_version("tidyselect",upgrade="never", version = "1.1.0")'
...
RUN Rscript -e 'remotes::install_version("remotes",upgrade="never", version = "2.2.0")'
RUN Rscript -e 'remotes::install_version("kableExtra",upgrade="never", version = "1.3.1")'
...
RUN Rscript -e 'remotes::install_version("writexl",upgrade="never", version = "1.3.1")'
...
RUN Rscript -e 'remotes::install_version("rhandsontable",upgrade="never", version = "0.3.7")'
